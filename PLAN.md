...
## Wiski program (voice → capability)

| Item | Notes |
|------|-------|
| Slice 1 — artifacts | **Shipped on branch** — dictate → history → Make Useful (8 types) → edit → approve → export w/ provenance → manual reuse; see `docs/wiski-architecture.md` |
...
| Slice 4 — Wiski repo sync | Push approved artifacts into the Wiski repo |
